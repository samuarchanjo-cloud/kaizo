...
def make_background():
    ...
    glow_draw.ellipse((1320, -350, 2180, 510), fill=(229, 72, 77, 24))
    glow_draw.ellipse((-480, 680, 380, 1540), fill=(216, 58, 64, 12))
...
def compose(title, subtitle, screens, output):
    ...
    draw.text((98, 43), title, font=font(BOLD, 46), fill="#171719")
    draw.text((100, 105), subtitle, font=font(REGULAR, 21), fill="#667085")
    draw.text((1758, 55), "16:9", font=font(BOLD, 20), fill="#D83A40")
    draw.text((1686, 87), "1920 × 1080", font=font(REGULAR, 16), fill="#667085")
    ...
    for index, (file_name, label) in enumerate(screens):
        ...
        draw.text((x + (target_w - label_w) // 2, label_y), label, font=font(BOLD, 18), fill="#171719")

    draw.line((64, 1020, 1856, 1020), fill="#E5E7EB", width=1)
    draw.text((64, 1035), "KAIZO · Tema claro · Gestão automotiva local-first", font=font(REGULAR, 15), fill="#667085")
    draw.text((1610, 1035), "Mobile · 390 × 844", font=font(REGULAR, 15), fill="#667085")
...
def compose_master():
    ...
    draw.text((98, 35), "KAIZO · Todas as telas · Tema claro", font=font(BOLD, 44), fill="#171719")
    draw.text((100, 94), "Visão completa do aplicativo mobile", font=font(REGULAR, 20), fill="#667085")
    draw.text((1758, 48), "16:9", font=font(BOLD, 20), fill="#D83A40")
    draw.text((1686, 80), "1920 × 1080", font=font(REGULAR, 16), fill="#667085")
