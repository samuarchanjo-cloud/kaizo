...
const catalog: VehicleCatalogEntry[] = [
  ...
  { brand: "BMW", models: [{ name: "Série 3", versions: ["320i", "330e"] }, { name: "X1", versions: ["sDrive20i", "xDrive25i"] }] },
  ...
  { brand: "Volkswagen", models: [{ name: "Gol", versions: ["1.0 MPI", "1.6 MSI"] }, { name: "Golf", versions: ["Comfortline 1.4 TSI", "GTI 2.0 TSI"] }, { name: "Nivus", versions: ["Comfortline 200 TSI", "Highline 200 TSI"] }, { name: "Polo", versions: ["MPI 1.0", "Comfortline 200 TSI"] }, { name: "T-Cross", versions: ["Comfortline 200 TSI", "Highline 250 TSI"] }] },
];
